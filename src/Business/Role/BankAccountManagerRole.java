...
import UserInterface.BankAccountManager.BankAccountManagerWorkAreaJPanel;
 ...
 */
public class BankAccountManagerRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system, AdExchange adEx, Bank bank ) {
        return new BankAccountManagerWorkAreaJPanel(userProcessContainer, bank);
    }
